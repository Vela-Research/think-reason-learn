"""GPTree: A decision tree classifier employing LLMs for dynamic feature generation.
...
class Questions(BaseModel):
    ...
    cummulative_memory: str = Field(..., description=CUMULATIVE_MEMORY_INSTRUCTIONS)
