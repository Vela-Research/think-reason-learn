...
- Do not restrict the question-generator LLM's creativity. Let it decide what to ask
  based on the clear detailed task description you give in this promtp template.
- Note the questions are generated by a series of LLM calls, so please let the template
  inform them to also generate a cumulative memory of the questions generated so far.
  This will help inform the next generators about what to look look into.
